...
// so as long as this sql server is connected, main menu function will continuously run
db.connect(() => {
    mainMenu();
});


// object literal arrqy for main menu questions
...
// array of object literals to hold question arrays depending on main menu selection (for add and update functions)
